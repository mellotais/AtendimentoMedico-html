...
<html lang="pt-br">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="./pacientes/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="./medico/bootstrap/css/bootstrap.min.css">

    <link rel="stylesheet" href="./style.css" />
    <link rel="preconnect" href="https://fonts.googleapis.com" />
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
    <link
      href="https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;700&display=swap" rel="stylesheet" />
  </head>
  <body>
      ...
      <div class="wrapper">
        ...
        <div class="menu">
          <ul>
            ...
            <li><a onClick="closeMenu()" href="#about">Cadastar</a></li>
            <li><a onClick="closeMenu()" href="#pacientes">Lista Paciente</a></li>
            <li><a onClick="closeMenu()" href="#medico">Lista Medico</a></li>
          </ul>

          <a class="button" onclick="closeMenu()" href="/amedico/logout.php">Sair da conta</a>
        ...
        <button aria-expanded-expanded="false"aria-label="Abrir Menu" onClick="openMenu()" class="open-menu" >
        ...
        <button aria-expanded-expanded="true" aria-label="Fechar Menu" onClick="closeMenu()"  class="close-menu" >
          <svg  width="40" height="40" viewBox="0 0 40 40" fill="none"  xmlns="http://www.w3.org/2000/svg">
    ...
    <section id="home">
      <div class="wrapper">
        ...
        <div class="col-b">
          <img src="./assets/mulher-com-moletom-verde.png" alt="Mulher vestindo moletom verde e sorrindo."/>
        </div>
    ...
    <section id="about">
      <div class="wrapper">
        <div class="col-a">
          ...
          <div class="content">
              <p>Possuimos uma equipe médica com profissionais qualificados para pronto atendimento e especialidades, 
                via telemedicina ou presencialmente. </p> <p>Fique tranquilo prezamos pela sua segurança por isso seus dados 
                não serão compartilhados com ninguém. </p> <br>

              <div class="button-group"> 
                  <a href="#addnew" data-toggle="modal"><button style= "border: none;border-radius: 4rem; padding: 1.6rem 3.2rem; width: fit-content;
                  color: white; font-size: 1.4rem; font-weight: 700; text-transform: uppercase; align-items: center;
                  justify-content: center; margin-bottom: 6rem; background:#00856F; text-decoration: none; transition: background 200ms;"><span class="glyphicon glyphicon-plus"></span> Cadastrar Paciente </button></a>

                  <a href="#addnewm" data-toggle="modal"><button style= "border: none;border-radius: 4rem; padding: 1.6rem 3.2rem; width: fit-content;
                  color: white; font-size: 1.4rem; font-weight: 700; text-transform: uppercase; align-items: center;
                  justify-content: center; margin-bottom: 6rem; background:#00856F; text-decoration: none; transition: background 200ms;"><span class="glyphicon glyphicon-plus"></span> Cadastrar Médico </button></a>

              </div> 
          </div>
        </div>
        <div class="col-b">
          <img src="./assets/doutor-feliz-segurando-prancheta-com-pacientes.png" alt="Doutor feliz segurando prancheta com pacientes.">
        </div>
      </div>
    </section>
    ...
    <header>
            ...
            <table class="table table-bordered table-striped" style="margin-top:20px;">
              ...
              <tbody>
                <?php
                  ...
                  include_once('./pacientes/connection.php');
                      ...
                      foreach ($db->query($sql) as $row) {
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="#delete_<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-trash"></span> Deletar</a>
                          </td>
                          <?php include('./pacientes/edit_delete_modal.php'); ?>
                        </tr>
                        <?php 
                      }
                  }
      ...
      <?php include('./pacientes/add_modal.php'); ?>
      <script src="./pacientes/jquery.min.js"></script>
      <script src="./pacientes/bootstrap/js/bootstrap.min.js"></script>
    </section>
    ...
    <header>
          ...
          <div class="div">
            ...
            <table class="table table-bordered table-striped" style="margin-top:20px;">
              ...
              <tbody>
                <?php
                  //include our connection
                  include_once('./medico/connection.php');
                  ...
                  try{	
                      ...
                      foreach ($db->query($sql) as $row) {
                        ...
                        <tr>
                          ...
                          <td><?php echo $row['email']; ?></td>
                          <td>
                            <a href="#edit<?php echo $row['id']; ?>" class="btn btn-success btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-edit"></span> Editar</a>
                            <a href="#delete<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-trash"></span> Deletar</a>
                          </td>
                          <?php include('./medico/edit_delete_modal.php'); ?>
                        </tr>
                        <?php 
                      }
                  }
      ...
      <?php include('./medico/add_modal.php'); ?>
      <script src="./medico/jquery.min.js"></script>
      <script src="./medico/bootstrap/js/bootstrap.min.js"></script>
    </section>
